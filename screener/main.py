    ...
    for rank, pick in enumerate(top_picks, start=1):
        ...
        picks_out.append({
            ...
            "indicators": {
                ...
                "sr_nearest_support":  pick.get("sr_nearest_support", 0.0),
                "sr_support_touches":  pick.get("sr_support_touches", 0),
                "sr_support_dist_pct": pick.get("sr_support_dist_pct", 99.0),
                "sr_near_support":     pick.get("sr_near_support", False),
            },
